	    	...
	    	<div class="table-responsive">
					<table class="table table-striped table-hover">
						...
						// Paginador 
							...
							$sql_registe = mysqli_query($con,"SELECT COUNT(*) as total_registro FROM tab_proy WHERE statu_proy = 1");
							...
							$query = mysqli_query($con,"SELECT * FROM tab_proy WHERE statu_proy = 1 ORDER BY ident_proy DESC LIMIT $desde,$por_pagina");
							mysqli_close($con);
