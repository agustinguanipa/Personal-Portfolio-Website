	...
	<div class="table-wrapper">
	    ...
	    <div class="row" style="padding-top: 2px;">
	    	<div class="col-sm-8">
				...
				<form action="publicacion_buscar_inactivo.php" method="GET" class="col-sm-4" style="padding-top: 1px;">
	    	...
	    	<div class="table-responsive">
					<table class="table table-striped table-hover">
						...
						// Paginador 
							...
							$sql_registe = mysqli_query($con,"SELECT COUNT(*) as total_registro FROM tab_proy WHERE statu_proy = 0");
							...
							$query = mysqli_query($con,"SELECT * FROM tab_proy WHERE statu_proy = 0 ORDER BY ident_proy DESC LIMIT $desde,$por_pagina");
							mysqli_close($con);
