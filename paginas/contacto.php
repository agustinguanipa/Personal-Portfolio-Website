...
if(isset($_POST["submit"]))
{
  ...
  if($error == '')
  {
    ...
    $mail->AddAddress('agustin_guanipa@hotmail.com', 'Agustin Guanipa - Sitio Web');   //Adds a "To" address
...
background: linear-gradient(90deg, rgba(56,176,222,1) 0%, rgba(66,136,255,1) 50%, rgba(0,74,255,1) 100%);'>
                  <h2 class='card-title text-white'><b>Agustin Guanipa</b></h2>
                  <p class='card-text text-white'><b>Sitio Web Personal</b></p>
                </div>
              </div>
               <p class=''>
...
<head>
  <title>Contacto | Agustin Guanipa</title>
</head>
              ...
              <form role="form" class="contact-form" method="post">
                <div class="row">
                  <div class="col-md-12 form-label">
                    <label><b class="text-center">Nombre y Apellido: </b></label>
